...
export default function EditClassPage() {
  ...
  const loadClass = async () => {
    try {
      const { data, error } = await classesAPI.getWithRoster(classId as string);
      ...
      toast.error(error.message || 'Error al cargar la clase');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { data, error } = await classesAPI.update(classId as string, {
        name: formData.name,
